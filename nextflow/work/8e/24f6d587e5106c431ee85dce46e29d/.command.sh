#!/bin/bash
    ...
    echo "[DEBUG] Processing small_chunkOperating Complex IT-Systems dataset"
    ...
    cat << EOF > metrics_small_chunkOperating Complex IT-Systems.json
{
    "process": "CONVERT_CSV_TO_JSON",
    "dataset_size": "small_chunkOperating Complex IT-Systems",
    "metrics": {
